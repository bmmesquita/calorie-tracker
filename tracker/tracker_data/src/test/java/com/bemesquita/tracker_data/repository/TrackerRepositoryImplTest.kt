...
import com.bemesquita.tracker_data.remote.malformedFoodResponse
import com.bemesquita.tracker_data.remote.validFoodResponse
...
class TrackerRepositoryImplTest {
    ...
    @Test
    fun `Search food, valid response, returns success result`() = runBlocking {
